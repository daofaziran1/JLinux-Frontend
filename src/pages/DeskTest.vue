      ...
      <el-header :height="headerHeight">
        ...
        <div class="weather-date">
          ...
          <el-popover placement="bottom" width="400" trigger="click">
            ...
            <H5Calendar lunar :touchthreshold="50" isshowtoday />
        ...
        <span class="mouse" @click="dialogVisible = true" circle
    ...
    createTermView() {
      ...
      new tt({
        propsData: {
          ...
          username: this.username, //传入一个回调函数
          password: this.password, //传入一个普通变量
        },
      }).$mount("#terminal");
      ...
      thisConsole.style.zIndex =
        this.zIndexMax > childrenCount ? this.zIndexMax + 1 : childrenCount;
